...
plot.bindis <- function(x) {
  barplot(height = x$Probability, names.arg = x$`Number of Successes`, xlab = "Number of Successes", ylab = "Probability", main = "Binomial Distribution")
}
...
bin_cumulative <- function(trials, prob) {
  ...
  names(bindi) <- c("Number of Successes", "Probability", "Cumulative")
  bindi[1] <- c(0:trials)
...
plot.bincum <- function(x) {
  plot(x = x$`Number of Successes`, y = x$Cumulative, type = "p", xlab = "Number of Successes", ylab = "Probability", main = "Cumulative Binomial Distribution")
...
summary.binvar <- function(x) {
  summary <- list("trials" = x[["Number of trials:"]],
